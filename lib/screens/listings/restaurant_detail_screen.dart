            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _Divider(),
                  const SizedBox(height: 24),
                  _ReviewSection(restaurantId: r.id),
...
class _ReviewSection extends ConsumerStatefulWidget {
  ...
  const _ReviewSection({required this.restaurantId});
...
class _ReviewSectionState extends ConsumerState<_ReviewSection> {
  ...
  Widget build(BuildContext context) {
    final reviewsAsync = ref.watch(
      restaurantReviewsProvider(widget.restaurantId),
    );
